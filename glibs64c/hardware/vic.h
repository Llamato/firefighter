    ...
    #define CHARS_PER_CHARSET 256
    #define CHARSET_SIZE CHARS_PER_CHARSET * BYTES_PER_CHAR_BITMAP
    #define BITMAP_WIDTH 320
    #define BITMAP_HEIGHT 200
    #define BITMAP_SIZE 8000
    ...
    #define SPRITE_EMBED_PARAMS(INDEX) clang::offset(2+INDEX * SPRITE_SIZE) limit(SPRITE_SIZE)
    ...
    #define COLOR_EMBED_PARAMS(COLORS_START_ADDRESS) clang::offset(COLORS_START_ADDRESS)
    #define CHARSET_EMBED_PARAMS(CHARSET_START_ADDRESS) limit(CHARSET_SIZE)
